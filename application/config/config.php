...
// Line 390: Enable Migrations
$config['migration_enabled'] = TRUE;

// Line 395: Set migration path
$config['migration_path'] = APPPATH . 'migrations/';

// Line 400: Set migration table name
$config['migration_table'] = 'migrations';

// Line 405: Auto migrate (Optional, but we will do it manually via controller for safety)
$config['migration_auto_latest'] = FALSE;

// Line 410: Migration file name format
